...
def generate_report(all_trips: List[Dict], valid_trips: List[Dict], point_usage: Dict, 
    ...
    lines.append("="*70)
    lines.append("")
    lines.append("This report analyzes and characterizes trip data based on the validation")
    lines.append("criteria detailed below. The categorization logic matches the methods used")
    lines.append("on the live analysis dashboard.")
    lines.append("")
    lines.append("Compare results with: https://jetlagpro.com/reviewers/analysis.html")
    lines.append("")
